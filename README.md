...
- Расскажи про ваше собеседование на предыдущее место работы? Какие вопросы задавали?
- Что привлекло тебя в нашей компании? Почему ты хочешь у нас работать?
- Какие стремления и перспективы видешь для себя? Кем видешь себя в компании через месяц, 3 месяца, год?
...
- Какие проблемы (помимо технических) встречались в твоей работе (плохо отлаженные процессы, неадекватное руководство)? Как ты пытались решать эти проблемы и удавалось ли их решить?
- В каких проектах ты участвовали? Какие фичи реализовывал?
- Какое было самое серьезное достижение (сделал сервис авторизации, реализовал микросервисную архитектуру, внедрил Docker, придумал и настроил CI/CD)?
- Был ли опыт руководства командой? Расскажи подробнее (что делал, как руководил, как заводил и оценивал таски, как распределял их, как трекал время). Всегда ли твоя команда успевала по срокам реализовывать проекты и закрывать большие таски?
- Какие технические моменты чаще всего вызывают у тебя затруднения?
- Расскажи про свои сильные и слабые стороны в разработке?
...
- Javascript - компилируемый или интерпретируемый? Что такое компиляция и интерпритация? Что быстрее (старт/перформанс)?
...
- Знаешь ли ты что-нибудь про nodejs? Сталкивался с ним? Использовал в работе? Можешь рассказать ключевые особенности?
...
- Объясни такое понятие, как "Чистая функция"
- Что такое AJAX? Почему эта технология стала популярна? Как она реализована в javascript?
- Можешь рассказать про JSON? XML? В чём отличие?
- Расскажи про подходы в программировании (императивный, декларативный)
...
- Что такое "связный список"? Односвазный, двусвязный? В чём разница? Можешь написать реализацию (псевдокодом) любого списка на выбор? В каком реальном кейсе может быть использован данный список?
