...
- Что такое javascript? Где он используется? Зачем он нужен и на каких устройствах можно встретить javascript в 2019 году?
...
- Расскажи про типизацию в Javascript. Что такое строгая/сильная/динамическая типизация?
...
- Ты знаешь как устроен 'hoisting' - подъем переменной?
...
- Расскажите про ES6
- Что такое 'rest' и 'spread' операторы? Приведи пример реального использования
