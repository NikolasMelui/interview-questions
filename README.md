...
- Назовите порождающие паттерны? Напишите реализацию любого на выбор
**(Abstract factory, Fatrory method, Builder, Singletone, Prototype)**
- Назовите поведенческие паттерны? Напишите реализацию любого на выбор
**(Chain of responsibility, Command, Iterator, Mediator, Momento, Observer, State, Strategy, Template method, Visitor, Interpreter)**
- Назовите структурные паттерны? Напишите реализацию любого на выбор
**(Adapter, Bridge, Composite, Decorator, Facade, Flyweight, Proxy)**
- Какие вы паттернов всего используете в работе?
- Что такое "антипаттерны"? Приведите пример
